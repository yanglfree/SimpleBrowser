...
| Reader and articles | partial | Live reader settings plus offline capture/library, bounded image caching, reading-position restore, full-text search, highlights, notes, tags/topics, archive, and Markdown/HTML export exist. StoreKit-backed Pro capture/retry gating and physical-device acceptance remain. |
